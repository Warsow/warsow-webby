...
function WarsowServer(type, ip, port)
{
  this.type = type;
  this.ip = ip;
  this.port = port;
...
WarsowServer.prototype.setNextRequest = function(nextRequest)
{
  this.nextRequest = (new Date()).getTime() + nextRequest;
}

WarsowServer.prototype.update = function()
{
...
WarsowServer.prototype.parseInfo = function()
{
  var info = {
    type: this.type,
    ip: this.ip,
